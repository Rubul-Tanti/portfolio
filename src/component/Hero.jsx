...
<Nav/>
<div className='flex flex-row justify-between mt-[15vh] '> <h1 className=' leading-none md:text-[100px] text-5xl lg:text-[150px] font-fontas pl-5 md:pl-10  lg:pl-20'><span className='text-[70px] md:text-[100px] lg:text-[200px] leading-none'>F</span>ull Stack </h1><div className='flex flex-row w-full justify-between items-center'><div className='text-gray-400 pl-5 text-sm text-center lg:text-xl md:text-lg'>Currently Available FOR
